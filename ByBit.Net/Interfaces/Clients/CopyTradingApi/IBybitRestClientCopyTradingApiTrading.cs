...
namespace Bybit.Net.Interfaces.Clients.CopyTradingApi
{
    ...
    /// </summary>
    public interface IBybitRestClientCopyTradingApiTrading
    {
        /// <summary>
        /// Get your positions
        ...
        /// <para><a href="https://bybit-exchange.github.io/docs/copy-trade/trade/trading-stop" /></para>
        /// </summary>
        /// <param name="symbol">Symbol</param>
        ...
        /// <param name="stopLossTriggerType">New stop loss trigger type</param>
        /// <param name="parentClientOrderId">Parent client order id</param>
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<WebCallResult> SetTradingStopAsync(string symbol, string parentOrderId, decimal? takeProfitPrice = null, decimal? stopLossPrice = null, TriggerType? takeProfitTriggerType = null, TriggerType? stopLossTriggerType = null, string? parentClientOrderId = null, CancellationToken ct = default);
    }
}
