...
namespace Bybit.Net.Interfaces.Clients.UsdPerpetualApi
{
    ...
    /// </summary>
    public interface IBybitRestClientUsdPerpetualApiTrading
    {
        #region Orders
        /// <summary>
        /// Place a new order
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<WebCallResult<IEnumerable<BybitConditionalOrderUsd>>> GetOpenConditionalOrdersRealTimeAsync(string symbol, long? receiveWindow = null, CancellationToken ct = default);
