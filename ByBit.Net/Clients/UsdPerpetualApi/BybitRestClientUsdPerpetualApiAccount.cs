...
{
    /// <inheritdoc />
    public class BybitRestClientUsdPerpetualApiAccount : IBybitRestClientUsdPerpetualApiAccount
    {
        private BybitRestClientUsdPerpetualApi _baseClient;

        internal BybitRestClientUsdPerpetualApiAccount(BybitRestClientUsdPerpetualApi baseClient)
        {
        ...
        /// <inheritdoc />
        public async Task<WebCallResult<BybitRiskId>> SetRiskLimitAsync(string symbol, OrderSide side, long riskId, PositionModeIdx? positionModeIdx = null, long? receiveWindow = null, CancellationToken ct = default)
        {
            var parameters = new Dictionary<string, object>()
            {
                { "symbol", symbol },
        ...
        /// <inheritdoc />
        public async Task<WebCallResult<IEnumerable<BybitPositionUsd>>> GetPositionsAsync(string? symbol = null, long? receiveWindow = null, CancellationToken ct = default)
        {
            var parameters = new Dictionary<string, object>();
        ...
        /// <inheritdoc />
        public async Task<WebCallResult<BybitMarginResult>> AddReduceMarginAsync(string symbol, OrderSide side, decimal margin, PositionModeIdx? positionModeIdx = null, long? receiveWindow = null, CancellationToken ct = default)
        {
            var parameters = new Dictionary<string, object>()
            {
                { "symbol", symbol },
        ...
        /// <inheritdoc />
        public async Task<WebCallResult> SetPositionModeAsync(PositionMode mode, string? symbol = null, string? asset = null, long? receiveWindow = null, CancellationToken ct = default)
        {
            var parameters = new Dictionary<string, object>();
            ...
            parameters.Add("mode", JsonConvert.SerializeObject(mode, new PositionModeConverter(false)));
            parameters.AddOptionalParameter("recv_window", receiveWindow?.ToString(CultureInfo.InvariantCulture) ?? _baseClient.ClientOptions.ReceiveWindow.TotalMilliseconds.ToString(CultureInfo.InvariantCulture));
