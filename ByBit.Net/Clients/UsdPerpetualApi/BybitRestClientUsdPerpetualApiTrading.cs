...
{
    /// <inheritdoc />
    public class BybitRestClientUsdPerpetualApiTrading : IBybitRestClientUsdPerpetualApiTrading
    {
        private BybitRestClientUsdPerpetualApi _baseClient;

        internal BybitRestClientUsdPerpetualApiTrading(BybitRestClientUsdPerpetualApi baseClient)
        {
