...
{
    /// <inheritdoc />
    internal class BybitRestClientContractApiTrading : IBybitRestClientContractApiTrading
    {
        private readonly BybitRestClientDerivativesApi _baseClient;

        internal BybitRestClientContractApiTrading(BybitRestClientDerivativesApi baseClient)
        {
